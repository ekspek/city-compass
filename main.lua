...
main.drawcompass = function()
	...
	for i = 1,#main.coordlist do
		tex.print([[\node at (]] .. round(90 - cmp.rad2deg(main.coordlist[i].heading)) .. [[:7) [circle, draw, align = center] {]] .. main.coordlist[i].name .. [[\\\SI{]] .. round(main.coordlist[i].distance / 1000) .. [[}{\kilo\meter}\\$]] .. round(90 - cmp.rad2deg(main.coordlist[i].heading)) ..[[\degree$};]])
	end
	tex.print([[
		\end{tikzpicture}
	]])
